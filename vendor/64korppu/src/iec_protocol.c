...
/*
 * Host-compatible IEC protocol implementation.
 *
 * Uses the same GPIO register macros as the AVR version, but these
 * map to mock_hardware.h globals (mock_DDRD, mock_PORTD, mock_PIND)
 * via config.h -> mock_hardware.h.
 */
